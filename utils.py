...
def get_args(is_train=True):
    ...
    parser.add_argument('--workers', type=int, help='number of data loading workers. Use -1 to use all cores.', default=4)#4
    ...
    parser.add_argument('--optimizer',default="Adadelta", action='store_true', help='Whether to use adam (default is Adadelta,SGD)')
    parser.add_argument('--lr', type=float, default=1, help='learning rate, default=1.0 for Adadelta')
    parser.add_argument('--beta1', type=float, default=0.9, help='beta1 for adam. default=0.9')
    parser.add_argument('--beta2', type=float, default=0.999, help='beta2 for adam. default=0.999')
    parser.add_argument('--rho', type=float, default=0.95, help='decay rate rho for Adadelta. default=0.95')
    parser.add_argument('--eps', type=float, default=1e-8, help='eps for Adadelta. default=1e-8')
    # parser.add_argument('--rho', type=float, default=0.9, help='decay rate rho for Adadelta. default=0.95')
    # parser.add_argument('--eps', type=float, default=1e-6, help='eps for Adadelta. default=1e-8')
    ...
    # --issel_aug --pattern --warp --geometry --weather --noise --blur --process
    ...
    # use cosine learning rate decay Corrupted image for 5970400
    # --scheduler --intact_prob 0.5 --isrand_aug --augs_num 3 --augs_mag 3
    ...
    ## --issemantic_aug --isrotation_aug --isscatter_aug --islearning_aug
    ...
    # --fast_acc --infer_model --quantized --static
